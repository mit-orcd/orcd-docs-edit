...
On Linux or Mac, Open the terminal program of your choice. On the Mac, you will have to make sure you have [XQuartz](https://www.xquartz.org/) installed and you will need to use either XQuartz or iTerm2 as your terminal.

ssh to the cluster log in node using your MIT kerberos ID. 
```
ssh -X <your_mit_kerb>@orcd-login.mit.edu
