...
3. **Subscribe to a Standard or Advanced Account Level.** Users with a valid cost object can pay a monthly fee to run higher-priority jobs and request more resources than the free tier. More information can be found on our [Compute Services](services/compute-services.md) page.
